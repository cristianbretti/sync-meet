...
const StartPage: FC<RouteComponentProps<any>> = () => {
    return <div className="min-h-screen flex flex-col items-center">
        ...
        <div className="w-full bg-grey-darker -mt-4 z-0 pt-4">
            <h2 className="mt-12 ml-12">How to get started:</h2>
            <div className="flex justify-around flex-wrap mb-12 mx-8 mt-4 mb-12">
                {bulletPoint("bg-red-dark", "Click the Create a new group button!")}
                {bulletPoint("bg-yellow-dark", "Specifying between which dates and times you want the meeting to take place!")}
                {bulletPoint("bg-green-light", "Copy the link and send to your colleagues to invite them!")}
            </div>
        </div>
