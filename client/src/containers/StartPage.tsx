...
const StartPage: FC<RouteComponentProps<any>> = () => {
    return <div className="min-h-screen flex flex-col items-center bg-grey-darkest text-white">
        ...
        <div className="w-full bg-grey-darker -mt-4 z-0 pt-4">
            ...
            <div className="flex justify-around flex-wrap mb-12 mx-8">
                ...
                {bulletPoint("bg-green-light", "Copy the invitation link and send to your colleagues!")}
            </div>
        </div>
