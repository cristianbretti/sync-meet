...
const CreateGroup: React.FC<RouteComponentProps<any>> = ({history}) => {
    ...
    const allValid = (validDates && validMeetingLength && validTimes && validUserName && validMeetingName);

    return (
        <div className="min-h-screen flex flex-col overflow-hidden bg-white">
            <form autoComplete="off" className="flex-1 flex flex-col bg-grey-darkest text-white shadow-inner overflow-hidden">
                <div className="flex-1 flex">
                    <div className="flex-1 flex flex-col items-end justify-center bg-white text-grey-darkest">
                        <div className="flex flex-col items-end justify-center overflow-hidden mr-4 font-bold text-lg md:text-3xl">
                            <div>CREATING</div>
                            <div className="text-green-dark font-medium">NEW</div>
                    ...
                    <div className="flex-3 flex items-center">
                        ...
                        />
                        <HelpHover className="pl-4 pt-1" text="This is the name this meeting will be represented with." />
                    </div>
                </div>
                <div className="flex-1 flex">
                    <div className="flex-1 flex flex-col items-end bg-white text-grey-darkest">
                        <div className="flex-1 flex items-center mr-4">
                            <i className={"text-4xl material-icons pt-2 " + " " + (validUserName ? "text-green-dark" : "")}>perm_identity</i>
                        </div>
                    </div>
                    <div className="flex-3 flex items-center">
                        <TextInput 
                        ...
                        />
                        <HelpHover className="pl-4 pt-1" text="This is the name that you will be represented with to your colleagues." />
                    </div>
                </div>
                <div className="flex-1 flex">
                    <div className="flex-1 flex flex-col items-end bg-white text-grey-darkest">
                        <div className="flex-1 flex items-center mr-4">
                            <i className={"text-3xl material-icons pt-2" + " " + (validDates ? "text-green-dark" : "")}>calendar_today</i>
                        </div>
                    </div>
                    <div className="flex-3 flex items-center flex-wrap">
                        ...
                        />
                        <i className="material-icons pt-2 pl-4">arrow_forward</i>
                        <DateInput
                            className="ml-4"
                            label="To date"
                            name={"toDate"}
                        ...
                        />
                        <HelpHover className="pl-4 pt-1" text="Look for available time slots for a meeting between (and including) these two dates." />
                    </div>
                </div>
                <div className="flex-1 flex">
                    <div className="flex-1 flex flex-col items-end bg-white text-grey-darkest">
                        <div className="flex-1 flex items-center mr-4">
                            <i className={"text-3xl material-icons pt-2" + " " + (validTimes ? "text-green-dark" : "")}>access_time</i>
                        </div>
                    </div>
                    <div className="flex-3 flex items-center flex-wrap">
                        <TimeInput
                        ...
                        />
                        <HelpHover className="pl-4 pt-1" text="Search for open time slots within the time period specified by these two inputs." />
                    </div>
                </div>
                <div className="flex-1 flex">
                    <div className="flex-1 flex flex-col items-end bg-white text-grey-darkest">
                        <div className="flex-1 flex items-center mr-4">
                            <i className={"text-3xl material-icons pt-2" + " " + (validMeetingLength ? "text-green-dark" : "")}>hourglass_full</i>
                        </div>
                    </div>
                    <div className="flex-3 flex items-center">
                        <TimeInput
                        ...
                        />
                        <HelpHover className="pl-4 pt-1" text="The estimated meeting length." />
                    </div>
                </div>
                <div className="flex-1 flex">
                    <div className="flex-1 flex flex-col items-end bg-white text-grey-darkest">
                        <div className="flex-1 flex items-center mr-4">
                            <i className={"text-3xl material-icons pt-2" + " " + (allValid ? "text-green-dark" : "")}>done_outline</i>
                        </div>
                    </div>
                    <div className="flex-3 flex items-center">
                        <GoogleLogin
